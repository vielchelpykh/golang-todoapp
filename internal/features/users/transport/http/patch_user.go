...
import (
	...
	core_http_types "github.com/vielchelpykh/golang-todoapp/internal/core/transport/http/types"
	core_http_utils "github.com/vielchelpykh/golang-todoapp/internal/core/transport/http/utils"
)
...
func (h *UsersHTTPHandler) PatchUser(w http.ResponseWriter, r *http.Request) {
	...
	userDomaion, err := h.usersService.PatchUser(ctx, userID, userPatch)
	if err != nil {
	...
	response := PatchUserResponse(userDTOFromDomain(userDomaion))
	responseHandler.JSONResponse(response, http.StatusOK)
}

func userPatchFromRequest(request PatchUserRequest) domains.UserPatch {
	return domains.UserPatch{
